...
import { Glasses, Calendar, MapPin, Star, ArrowRight, Music } from 'lucide-react';
...
const NightlifePage: React.FC = () => {
  ...
  const featuredArticles = contentDistributionService.getFeaturedArticlesForCategory('nightlife', 3);
      ...
      <div className="py-20 bg-gray-50">
        <div className="px-4 mx-auto max-w-6xl sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <p className="text-gray-500">
              Curated nightlife destinations
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="bg-white border border-gray-100 p-8 transition-all duration-300 hover:opacity-95">
              <h3 className="text-lg font-medium text-midnight-black tracking-tight mb-4">Exclusive Clubs</h3>
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                VIP access to Dubai's most prestigious nightclubs with world-renowned DJs and performers
              </p>
              <div className="text-sm text-gray-400">Featured Events Available</div>
            </div>

            {/* Rooftop Bars */}
            <div className="bg-white border border-gray-100 p-8 transition-all duration-300 hover:opacity-95">
              <h3 className="text-lg font-medium text-midnight-black tracking-tight mb-4">Rooftop Bars</h3>
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Sky-high cocktails with stunning city views at Dubai's most sophisticated venues
              </p>
            ...
            {/* Live Entertainment */}
            <div className="bg-white border border-gray-100 p-8 transition-all duration-300 hover:opacity-95">
              <h3 className="text-lg font-medium text-midnight-black tracking-tight mb-4">Live Entertainment</h3>
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Concerts, comedy shows, and special performances at Dubai's premier entertainment venues
              </p>
              <div className="text-sm text-gray-400">Event Calendar</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 bg-white border-t border-gray-100">
        <div className="px-4 mx-auto max-w-6xl sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-500 mb-12 max-w-xl mx-auto">
            Be the first to access exclusive events and VIP experiences
          </p>
          <button 
